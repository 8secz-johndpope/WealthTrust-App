...
@interface RLMArray (SWIFT_EXTENSION(ChartsRealm))
@end


@interface RLMResults (SWIFT_EXTENSION(ChartsRealm))
@end

@protocol IChartDataSet;

SWIFT_CLASS("_TtC11ChartsRealm12RealmBarData")
...
- (void)loadResults:(RLMRealm * _Nonnull)realm modelName:(NSString * _Nonnull)modelName;
- (void)loadResults:(RLMRealm * _Nonnull)realm modelName:(NSString * _Nonnull)modelName predicate:(NSPredicate * _Nullable)predicate;
...
SWIFT_CLASS("_TtC11ChartsRealm15RealmBubbleData")
...
SWIFT_CLASS("_TtC11ChartsRealm15RealmCandleData")
...
SWIFT_CLASS("_TtC11ChartsRealm15RealmChartUtils")
...
SWIFT_CLASS("_TtC11ChartsRealm13RealmLineData")
...
SWIFT_CLASS("_TtC11ChartsRealm12RealmPieData")
...
SWIFT_CLASS("_TtC11ChartsRealm14RealmRadarData")
...
SWIFT_CLASS("_TtC11ChartsRealm16RealmScatterData")
